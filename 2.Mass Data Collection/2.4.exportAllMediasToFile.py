...
print(f"Collecting medias informations {number_of_request_per_batch} requests per {wait_time_between_batch_in_seconds}+ seconds")
try:
    while has_next_page:
        total_requests = 0
...
resultDataFrame.to_json("medias.json")
